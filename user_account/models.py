...
class UserManager(BaseUserManager):
    def create_user(self, email, user_name=None, password=None, is_active=True, is_staff=False, is_admin=False):
        if not email:
    ...
    def create_staffuser(self, email, user_name=None, password=None):
    ...
    def create_superuser(self, email, user_name=None, password=None):
        user = self.create_user(
            email,
            user_name=user_name,
            password=password,
...
class User(AbstractBaseUser):
    ...
    REQUIRED_FIELDS = []  # ['user_name'] #python manage.py createsuperuser
